...
| `docs/readthedocs/conf.py` | Sphinx config for main documentation |
| `docs/python_api/conf.py` | Sphinx config for standalone Python API |
| `scripts/build_docs.py` | Multi-version GitHub Pages builder |
| `scripts/docs_versions.txt` | List of versions to build for GitHub Pages |
| `.github/workflows/api_doc.yml` | GitHub Actions workflow for API docs |
| `pixi.toml` | Local build task definitions |
