...
inline void _ccdPtNearestUpdate(ccd_pt_t *pt, ccd_pt_el_t *el)
{
...
ccd_pt_vertex_t *ccdPtAddVertex(ccd_pt_t *pt, const ccd_support_t *v)
{
    ...
    vert->dist = dartCcdVec3Len2(&vert->v.v);
    dartCcdVec3Copy(&vert->witness, &vert->v.v);
                                          ...
                                          ccd_pt_vertex_t *v2)
{
    ...
    a = &edge->vertex[0]->v.v;
    b = &edge->vertex[1]->v.v;
    edge->dist = dartCcdVec3PointSegmentDist2(ccd_vec3_origin, a, b, &edge->witness);
                                          ...
                                          ccd_pt_edge_t *e3)
{
    ...
    face->dist = dartCcdVec3PointTriDist2(ccd_vec3_origin, a, b, c, &face->witness);
...
void ccdPtRecomputeDistances(ccd_pt_t *pt)
{
    ...
    ccdListForEachEntry(&pt->vertices, v, ccd_pt_vertex_t, list){
        dist = dartCcdVec3Len2(&v->v.v);
        v->dist = dist;
        dartCcdVec3Copy(&v->witness, &v->v.v);
    }

    ccdListForEachEntry(&pt->edges, e, ccd_pt_edge_t, list){
        a = &e->vertex[0]->v.v;
        b = &e->vertex[1]->v.v;
        dist = dartCcdVec3PointSegmentDist2(ccd_vec3_origin, a, b, &e->witness);
        e->dist = dist;
    }
    ...
    ccdListForEachEntry(&pt->faces, f, ccd_pt_face_t, list){
        ...
        dist = dartCcdVec3PointTriDist2(ccd_vec3_origin, a, b, c, &f->witness);
        f->dist = dist;
    }
}
...
void ccdPtDumpSVT2(ccd_pt_t *pt, FILE *fout)
{
    ...
    ccdListForEachEntry(&pt->vertices, v, ccd_pt_vertex_t, list){
        ...
        fprintf(fout, "%lf %lf %lf\n",
                dartCcdVec3X(&v->v.v), dartCcdVec3Y(&v->v.v), dartCcdVec3Z(&v->v.v));
    }
