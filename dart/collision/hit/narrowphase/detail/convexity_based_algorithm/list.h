 ...
 * Initialize list.
 */
inline void ccdListInit(ccd_list_t* l);

inline ccd_list_t* ccdListNext(ccd_list_t* l);
inline ccd_list_t* ccdListPrev(ccd_list_t* l);

/**
 * Returns true if list is empty.
 */
inline int ccdListEmpty(const ccd_list_t* head);

/**
 * Appends item to end of the list l.
 */
inline void ccdListAppend(ccd_list_t* l, ccd_list_t* item);

/**
 * Removes item from list.
 */
inline void ccdListDel(ccd_list_t* item);
...
inline void ccdListAppend(ccd_list_t* l, ccd_list_t* newl)
{
  newl->prev = l->prev;
  newl->next = l;
  l->prev->next = newl;
