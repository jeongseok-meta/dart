 ...
 */
inline int ccdPtDelVertex(ccd_pt_t* pt, ccd_pt_vertex_t*);
inline int ccdPtDelEdge(ccd_pt_t* pt, ccd_pt_edge_t*);
inline int ccdPtDelFace(ccd_pt_t* pt, ccd_pt_face_t*);
...
inline int ccdPtDelVertex(ccd_pt_t* pt, ccd_pt_vertex_t* v)
{
...
inline int ccdPtDelEdge(ccd_pt_t* pt, ccd_pt_edge_t* e)
{
...
inline int ccdPtDelFace(ccd_pt_t* pt, ccd_pt_face_t* f)
{
  ccd_pt_edge_t* e;
  size_t i;
